...
def main():
    ...
    print("""
  ######################################
  # MelbCamera Development Environment Setup #
  ######################################

  This script will create your MelbCamera dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your MelbCamera project folder:
    [Arma 3 installation directory]\\{} => MelbCamera project folder
    P:\\{}                              => MelbCamera project folder
